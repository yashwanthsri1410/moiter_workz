...
import { Users, UserPlus, Clock, Shield, TimerIcon, Clock1, Clock10, AlertTriangle, UserCheck, FileText } from "lucide-react";
    ...
    return (
        <div className="dashboard-container-dx91u">
            ...
            <div className="dashboard-row1-dx91u">
                ...
                <div className="stat-card-dx91u total-customers-dx91u corner-box">
                    ...
                    <div className="card-bottom-dx91u">
                        ...
                        </p> <p className="stat-sub-dx91u mb-[10px]">
                ...
                <div className="stat-card-dx91u customer-today-dx91u corner-box">
                    ...
                    <p className="stat-value-dx91u highlight-green-dx91u">{data?.kycVerifiedCount}
                        <p className="stat-sub-dx91u">
                            <span className="text-[#00ff00fa] ">+12.8% </span>this month
                        </p>
                    </p>
                    <div>
                        <p className="stat-sub-dx91u">
                        ...
                        <p className="text-[#00ff00fa] text-[15px]">
                ...
                <div className="stat-card-dx91u kyc-pending-dx91u corner-box">
                    ...
                    <p className="stat-value-dx91u  highlight-red-dx91u">
                        ...
                        45
                        <p className="stat-sub-dx91u">
                            <span className="text-[#00ff00fa] ">-8.2% </span> from last week
                        </p>
                    </p>
                    <div>
                        <p className="stat-sub-dx91u">
                        ...
                        <p className="text-[#ff6467]  text-[15px]">
                            12 cases
                        </p>
                    </div>
                </div>
            ...
            <div className="dashboard-row2-dx91u">
                <div className="stat-card-dx91u high-risk-dx91u corner-box " style={{ paddingBottom: "45px" }}>
                    <h2 className="text-[#00d4aa] text-[15px] flex  items-center gap-2"> <AlertTriangle className="w-4 h-4" />Priority Alerts</h2>
                    ...
                    <div className="bg-[#3b1c1c] text-[#f87171] px-4 py-2 text-[15px] rounded-[18px] flex items-center gap-3">
                        ...
                        <span>12 customers flagged for potential money laundering activities</span>
                    </div>
                ...
                <div>
                    <div className="stat-card-dx91u high-risk-dx91u corner-box " style={{ paddingBottom: "30px" }}>
                        <h2 className="text-[#00d4aa] text-[15px] flex  items-center gap-2">Compliance Metrics</h2>
                        {metrics.map((metric, index) => (
                            <div key={index} className="space-y-2">
                                <div className="flex justify-between text-sm text-gray-300">
                                    <span className="text-[12px]">{metric.label}</span>
                                    <span className="text-[#00ff00fa] text-[12px]">{metric.percent}%</span>
                                </div>
