                ...
                <div className="card-header">
                    <div className="card-header-left">
                        ...
                        <div>
                            ...
                            <p className="header-subtext">Review and approve product configurations</p>
                        </div>
                    </div>
                            ...
                            <tbody>
                                {paginatedConfigurations.map((cfg, idx) => (
                                    <tr key={cfg.productId || idx} className="table-row">
                                        <td className="table-content text-[#00d4aa]">{cfg.productId}</td>
                                        ...
                                        <td >
                                            <span
                                                className={`px-2 py-1 rounded text-[10px] ${cfg.status === 0 ? "checker" : cfg.status === 1 ? "infra" : cfg.status === 2 ? "superuser" : cfg.status === 3 ? "maker" : ""
                                                    }`}
                                            >
