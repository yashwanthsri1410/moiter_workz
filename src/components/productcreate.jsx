        ...
        <div className="config-forms">
            <div className="card-header">
                ...
                <div className="card-header-right">
                    <button className="btn-outline" onClick={() => setformOpen(prev => !prev)}>
                        {formOpen ? (<><span className="btn-icon"><EyeOff className="w-4 h-4" /></span>Hide Form</>) :
                            (<><span className="btn-icon"><Eye className="w-4 h-4" /></span>Show Form</>)}
                    </button>
                ...
                <form onSubmit={handleSubmit} className="department-form mt-[18px]">
                    <div className="page-header">
                        <h2 className="form-title flex ">
                            ...
                            {editingId ? "Update Product Configuration" : "Create Product Configuration"}
                        </h2>
                    </div>
        ...
        `}
            ...
            <div className="guidelines-card">
                ...
                <div className="guidelines-grid">
                    <p>📦 <span>Basic Details:</span> Provide product name, description, and category</p>
                    <p>💲 <span> Pricing Setup:</span> Define price, currency, and applicable taxes</p>
                </div>

                <div className="guidelines-grid">
                    <p>⚙️ <span> Configuration:</span> Set product attributes, features, and usage limits</p>
                    <p>📜 <span> Compliance:</span> Ensure product meets regulatory and policy requirements</p>
                </div>
            </div>
        </div>
    )
