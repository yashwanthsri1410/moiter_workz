            ...
            <div className="partner-overview-card">
                ...
                <div className="partner-overview-content">
                    <div className="partner-overview-section">
                        <p>
                            <span className="partner-overview-label">Partner Name</span> <br />
                            <span className="partner-overview-bold">
                                {selectedPartner.partnerName}
                            </span>
                        </p>
                        <p>
                            <span className="partner-overview-label">Partner Type</span> <br />
                            <span>{selectedPartner.partnerType}</span>
                        </p>
                        <p>
                            <span className="partner-overview-label">Status</span> <br />
                            <span>{selectedPartner.partnerStatus}</span>
                        </p>
                    </div>

                    <div className="partner-overview-section">
                        <p>
                            <span className="partner-overview-label">Contact Name</span> <br />
                            <span className="partner-overview-bold">
                        ...
                        <p>
                            ...
                            <span>{selectedPartner.kycStatus}</span>
                        </p>
                    </div>
                    ...
                    <div className="partner-overview-section">
                        ...
                        <p>
                            <span className="partner-overview-label">Portal Access</span> <br />
                            <span className="partner-overview-bold">
                        ...
                        <p>
                            ...
                            <span className="partner-overview-bold">
                                {selectedPartner.address
                                    ? JSON.parse(selectedPartner.address).address
                                    : "-"}
                            </span>
                        </p>
                        <p>
                ...
                <div className="partner-overview-content">
                    ...
                    <div className="partner-overview-section">
                        <p>
                            ...
                            <span>{selectedPartner.riskProfile}</span>
                        </p>
                        <p>
            ...
            {showModal && (
                <div className="modal-overlay">
                    <div className="modal-container">
                        <h2 className="modal-title">Confirm Partner Approval</h2>
                        <p className="modal-subtext">
                            Are you sure you want to approve{" "}
                            <b>{selectedPartner.partnerName}</b>? This action cannot be undone.
                        </p>
                        <label className="modal-label">Approval Remarks (Optional)</label>
                        <textarea
                            value={remarks}
