    ...
    <div className="config-forms">
      ...
      <div className="bg-[#0c0f16] border border-[#1a1f2e] rounded-xl p-6 mt-6">
        ...
        <div className="flex items-center space-x-2 mb-2">
          ...
          <h3 className="text-teal-400 text-xs sm:text-sm md:text-[15px]">
            Transaction Limits
          </h3>
        </div>
      ...
      {/* Compliance */}
      <div className="bg-[#0c0f16] border border-[#1a1f2e] rounded-xl p-4 sm:p-6 mt-6">
        {/* Header */}
        <div className="flex items-center space-x-2 mb-2">
      ...
      <div className="bg-[#0c0f16] border border-[#1a1f2e] rounded-xl p-6 mt-6">
        <div className="flex items-center space-x-2 mb-2">
          ...
          <h3 className="text-teal-400 text-[13px] sm:text-[15px]">
            Validity Settings
          </h3>
        </div>
      ...
      <div className="bg-[#0d0f13] p-4 rounded-md border border-gray-800 mt-5">
        <div className="flex items-center space-x-2 mb-2">
          ...
          <h3 className="text-teal-400 text-[13px] sm:text-[15px]">Remarks</h3>
        </div>
