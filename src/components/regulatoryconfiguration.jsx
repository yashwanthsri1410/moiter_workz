  ...
  const API_BASE_URL = process.env.REACT_APP_API_BASE_URL;
    ...
    const handleSubmit = async (e) => {
        ...
        const payload = {
            ...
            transactionReportableFlags: typeof form.transactionReportableFlags === "string"
           ...
           ...(isEditing ? { modifiedBy: username } : { createdBy: username }),
            metadata: {
                ...
                auditMetadata: {
                    createdBy: username,
                    createdDate: isEditing ? form.metadata.auditMetadata.createdDate : new Date().toISOString(),
                    modifiedBy: username,
                    modifiedDate: new Date().toISOString(),
    ...
    const numberFields = [
        "cashLoadingLimit", "maxBalance", "minBalance", "maxLoadAmount", "dailySpendLimit", "monthlySpendLimit",
        "yearlySpendLimit", "txnCountLimitPerDay", "refundLimit", "maxCashWithdrawalAmount",
        "validityPeriodMonths", "gracePeriodDays", "customerAgeMin", "customerAgeMax",
        ...
        <div className="config-forms">
            ...
            <div className="card-header">
                <div className="card-header-left">
                    ...
                    <div>
                        <h1 className="header-title">Regulatory Configuration Management</h1>
                        <p className="header-subtext">Configure regulatory compliance and guidelines</p>
                    </div>
                </div>
            ...
            {formOpen && (
                <form onSubmit={handleSubmit} className="department-form mt-[18px]">
                    <div className="page-header">
                        <h2 className="form-title flex ">
                            ...
                            {editingId ? "Update Regulatory Configuration" : "Create Regulatory Configuration"}
                        </h2>
                    </div>
                    ...
                    <div className="form-section bg-[#0d0f13] p-4 rounded-md border border-gray-800">
                        <h3 className="section-title text-teal-400 mb-4">Transaction Limits</h3>

                        <div className="grid grid-cols-3 gap-4">
                            <div className="form-group flex flex-col">
                                <label className="text-sm text-gray-300 mb-1">Cash Loading Limit</label>
                                <input
                                    type="number"
                            ...
                            <div className="form-group flex flex-col">
                                <label className="text-sm text-gray-300 mb-1">Daily Spend Limit</label>
                                <input
                                    type="number"
                            ...
                            <div className="form-group flex flex-col">
                                <label className="text-sm text-gray-300 mb-1">Monthly Spend Limit</label>
                                <input
                                    type="number"
                            ...
                            <div className="form-group flex flex-col">
                                <label className="text-sm text-gray-300 mb-1">Min Balance</label>
                                <input
                                    type="number"
                                    name="minBalance"
                            ...
                            <div className="form-group flex flex-col">
                                <label className="text-sm text-gray-300 mb-1">Max Balance</label>
                                <input
                                    type="number"
                                    name="maxBalance"
                            ...
                            <div className="form-group flex flex-col">
                                <label className="text-sm text-gray-300 mb-1">Max Load Amount</label>
                                <input
                                    type="number"
                                    name="maxLoadAmount"
                    ...
                    <div className="form-section bg-[#0d0f13] p-4 rounded-md border border-gray-800">
                        <h3 className="section-title text-teal-400 mb-4">Features & Validity Settings</h3>
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="form-group flex flex-col">
                                        <label className="text-sm text-gray-300 mb-1">Min Age</label>
                                        <input
                                            type="number"
                                            name="customerAgeMin"
                        ...
                        <div className="grid grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <div className="flex flex-col gap-3">
                                    {options.map((method) => {
                                        const checked = (form.topupMethod || "").split(",").includes(method); // ✅ works with string
                                        return (
              ...
              transition-colors duration-200`}
                            ...
                            <div>
                                <h4 className="compliance-title text-gray-200 mb-2">Unloading Channels</h4>
                                <div className="flex flex-col gap-3">
                                    {channels.map((method) => {
            ...
            <div className="guidelines-card">
                <h3 className="guidelines-title">Regulatory Configuration Guidelines</h3>

                <div className="guidelines-grid">
                    <p>⚖️ <span>Compliance Mapping:</span> Assign applicable regulatory frameworks (e.g., GDPR, AML, KYC)</p>
                    <p>📜 <span> Policy Upload:</span> Ensure regulatory policies and certifications are uploaded</p>
                </div>

                <div className="guidelines-grid">
                    <p>🔒 <span> Access Control:</span> Define permissions in line with regulatory requirements</p>
                    <p>📊 <span> Audit Trail:</span> Enable logging to track changes and regulatory approvals</p>
                </div>
