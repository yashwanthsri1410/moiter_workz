...
export default function RegulatoryConfig() {
  ...
  return (
    <div className="config-forms">
      ...
      {formOpen && (
          ...
          <div className="form-section bg-[#0d0f13] p-4 rounded-md border border-gray-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="form-group flex flex-col">
                ...
                />
                <ErrorText errTxt={error.cashLoadingLimit} className="text-[9px] sm:text-xs"/>
              </div>
              ...
              <div className="form-group flex flex-col">
                ...
                <input
                  ...
                  placeholder="Enter amount"
                />
                <ErrorText errTxt={error.dailySpendLimit} className="text-[9px] sm:text-xs"/>
              </div>
              ...
              <div className="form-group flex flex-col">
                ...
                <input
                  ...
                  placeholder="Enter amount"
                />
                <ErrorText errTxt={error.minBalance} className="text-[9px] sm:text-xs"/>
              </div>
              ...
              <div className="form-group flex flex-col">
                ...
                <input
                  ...
                  placeholder="Enter amount"
                />
                <ErrorText errTxt={error.maxBalance} className="text-[9px] sm:text-xs"/>
              </div>
              ...
              <div className="form-group flex flex-col">
                ...
                <input
                  ...
                  placeholder="Enter amount"
                />
                <ErrorText errTxt={error.maxLoadAmount} className="text-[9px] sm:text-xs"/>
              </div>
            </div>
          </div>
        ...
        <div className="form-section bg-[#0d0f13] p-4 rounded-md border border-gray-800">
  <h3 className="section-title text-teal-400 mb-4 text-left">
    Features & Validity Settings
  </h3>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="text-left">
      <h4 className="text-teal-400 text-[15px] mb-[5px] text-left">
      ...
      <div className="form-group flex flex-col text-left">
        <label className="text-sm text-gray-300 mb-1 text-left">Min Age</label>
        <input
          type="number"
          name="customerAgeMin"
        ...
        {channels.map((method) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-xs sm:text-sm">{formattedMethod}</span>
            </label>
          );
        })}
      </div>
  ...
  <table className="min-w-full text-left text-sm sm:text-base border-collapse ">
    <thead className="table-head bg-gray-50">
      <tr>
        <th className="table-cell px-4 py-2 whitespace-nowrap">Configuration Name</th>
        <th className="table-cell px-4 py-2 whitespace-nowrap">Program Type</th>
        <th className="table-cell px-4 py-2 whitespace-nowrap">KYC Level</th>
        <th className="table-cell px-4 py-2 whitespace-nowrap">Remarks</th>
        <th className="table-cell px-4 py-2 whitespace-nowrap">Actions</th>
      </tr>
    </thead>
    <tbody>
      {paginatedData &&
        paginatedData.map((cfg, idx) => {
          ...
          return (
            <tr key={cfg.productId || idx} className="table-row border-b">
  ...
  <div className="guidelines-grid grid grid-cols-1 sm:grid-cols-2 gap-3 text-[10px] sm:text-sm text-gray-300">
    <p className="text-xs sm:text-sm break-words">
      ⚖️ <span className="font-medium text-gray-200">Compliance Mapping:</span>{" "}
      Assign applicable regulatory frameworks (e.g., GDPR, AML, KYC)
    </p>
    <p className="text-xs sm:text-sm break-words">
      📜 <span className="font-medium text-gray-200">Policy Upload:</span> Ensure
      regulatory policies and certifications are uploaded
    </p>
  </div>
  ...
  <div className="guidelines-grid grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3 text-[10px] sm:text-sm text-gray-300">
    <p className="text-xs sm:text-sm break-words">
      🔒 <span className="font-medium text-gray-200">Access Control:</span> Define
      permissions in line with regulatory requirements
    </p>
    <p className="text-xs sm:text-sm break-words">
      📊 <span className="font-medium text-gray-200">Audit Trail:</span> Enable
      logging to track changes and regulatory approvals
    </p>
  </div>
</div>
