    ...
    <div>
      ...
      <div className="partner-overview-card mt-4">
        ...
        <div className="mt-3 partner-overview-card rounded-lg text-sm ">
          <p>
            <strong>Selected Coordinates:</strong> {position.lat.toFixed(5)},{" "}
            {position.lng.toFixed(5)}
          </p>
        </div>
      </div>
      ...
      <div className="partner-overview-card">
        ...
        <div className="partner-overview-content">
          <div className="partner-overview-section">
            <div>
              <span className="partner-overview-label">Payment Types</span>{" "}
              <br />
              <div className="flex gap-2 flex-wrap mb-2">
                {selectedMerchant?.paymentType?.split(",").map((type, idx) => {
      ...
      <div className="partner-overview-card">
        ...
        <div className="partner-overview-content">
          <div className="partner-overview-section">
            ...
            <p>
              <span className="partner-overview-label">
