...
export default function EmployeeView({ selectedEmployee, setSelectedEmployee }) {
    ...
    const submitAction = async () => {
        try {
            ...
            await axios.post(`${API_BASE_URL}/ums/api/UserManagement/ApproveEmployee`, payload);
        ...
        <>
            <div className="card-header mb-6">
                ...
                <div className="card-header-left flex items-center gap-3">
                    <button className="approval-back-button" onClick={() => setSelectedEmployee(null)}>
                    ...
                    <div className="modal-overlay">
                        <div className="modal-container">
                            ...
                            <p className="modal-subtext">
                                Are you sure you want to approve product {selectedEmployee.productName}?
